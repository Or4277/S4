...
// --- CONFIG BASE DE DONNÉES (OBLIGATOIRE) ---
// Use database settings from the loaded config.php (set in bootstrap.php)
// Build DSN and register PDO service accordingly
if (!empty($config['database'])) {
  ...
  Flight::register('db', 'PDO', [ $dsn, $dbUser, $dbPass ]);
} else {
  // Fallback to the previously hardcoded DSN if config is missing
  Flight::register('db', 'PDO', [
    'mysql:host=127.0.0.1;dbname=produit;charset=utf8',
    'root',
    ''
  ]);
}
